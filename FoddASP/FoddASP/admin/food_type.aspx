...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" runat="server">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <asp:Button ID="btn_tim" OnClick="btn_tim_Click" runat="server"   Text="Tìm" /><br />
            <br />
            <asp:Button ID="btn_them_loai" runat="server" OnClick="btn_them_loai_Click" Text="Thêm Loại Sản Phẩm" /><br />
        </div>
        <div class="card-body">
                    ...
                    <asp:Repeater ID="rpt_member" runat="server">
                        ...
                        <ItemTemplate>
                            ...
                            <tr style="color: black; text-align: center">
                                ...
                                <td><%#Eval("type_pos") %></td>
                                <td><img src="img/<%#Eval("type_img") %>" /></td>
